...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
    { FRAMEWIN_CreateIndirect,  "设置",             0,                       0,  0,  480,272,FRAMEWIN_CF_MOVEABLE,0},
    { BUTTON_CreateIndirect,    "LED设置",               GUI_ID_BUTTON0,          91, 29, 101,59, 0,0},
    { BUTTON_CreateIndirect,    "HID设置",               GUI_ID_BUTTON1,          253,29, 101,59, 0,0},
    { BUTTON_CreateIndirect,    "控制器设置",              GUI_ID_BUTTON2,          91, 114,101,59, 0,0},
    { BUTTON_CreateIndirect,    "取消",            GUI_ID_CANCEL,           328,187,101,59, 0,0},
    { BUTTON_CreateIndirect,    "时间设置",              GUI_ID_BUTTON3,          253,114,101,59, 0,0}
};
